...
module.exports = { session: process.env.SESSION_ID || 'ezra',
    ...
    OWNER_NAME : process.env.OWNER_NAME || "Official Mentor",
    NUMERO_OWNER : process.env.NUMERO_OWNER || "254741669751",  
              
    AUTO_READ_STATUS: process.env.AUTO_READ_STATUS || "non",
    AUTO_DOWNLOAD_STATUS: process.env.AUTO_DOWNLOAD_STATUS || 'non',
    AUTO_REACT: process.env.AUTO_REACTION || "non",  
     AUTO_SAVE_CONTACTS : process.env.AUTO_SAVE_CONTACTS || 'no',
    URL: process.env.URL || "https://files.catbox.moe/d7o1fx.jpg",  
    URL2: process.env.URL2 || "https://files.catbox.moe/d7o1fx.jpg",
